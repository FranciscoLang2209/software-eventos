...
import type { DeletePagoState } from "@/app/(protected)/catering/actions";

type DeleteCateringPagoFormProps = {
  action: (
...
export function DeleteCateringPagoForm({ action }: DeleteCateringPagoFormProps) {
